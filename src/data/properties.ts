...
export const featuredProperties: Property[] = [
  {
    ...
    coveredAreaM2: 72,
    area: "72 m²",
    image: "/images/demo/city-bell/01.jpg",
    imageAlt: "Departamento de 3 ambientes en City Bell",
    description:
      "Departamento de 3 ambientes en City Bell.\n\nTiene 2 dormitorios, 1 baño y 72 m² de superficie cubierta.",
    photos: [
      { id: "demo-1-foto-1", src: "/images/demo/city-bell/01.jpg", alt: "Departamento de 3 ambientes en City Bell, foto 1" },
      { id: "demo-1-foto-2", src: "/images/demo/city-bell/02.jpg", alt: "Departamento de 3 ambientes en City Bell, foto 2" },
      { id: "demo-1-foto-3", src: "/images/demo/city-bell/03.jpg", alt: "Departamento de 3 ambientes en City Bell, foto 3" },
      { id: "demo-1-foto-4", src: "/images/demo/city-bell/04.jpg", alt: "Departamento de 3 ambientes en City Bell, foto 4" },
      { id: "demo-1-foto-5", src: "/images/demo/city-bell/05.jpg", alt: "Departamento de 3 ambientes en City Bell, foto 5" },
      { id: "demo-1-foto-6", src: "/images/demo/city-bell/06.webp", alt: "Departamento de 3 ambientes en City Bell, foto 6" },
      { id: "demo-1-foto-7", src: "/images/demo/city-bell/07.webp", alt: "Departamento de 3 ambientes en City Bell, foto 7" },
      { id: "demo-1-foto-8", src: "/images/demo/city-bell/08.webp", alt: "Departamento de 3 ambientes en City Bell, foto 8" },
      { id: "demo-1-foto-9", src: "/images/demo/city-bell/09.jpg", alt: "Departamento de 3 ambientes en City Bell, foto 9" },
    ],
  },
  {
    id: "demo-2",
